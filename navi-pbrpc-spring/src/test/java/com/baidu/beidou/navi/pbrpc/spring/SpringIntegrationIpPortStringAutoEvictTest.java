 ...
 * @author zhangxu
 */
@ContextConfiguration(locations = {"classpath*:autoevict/applicationContext.xml"})
public class SpringIntegrationIpPortStringAutoEvictTest extends AbstractJUnit4SpringContextTests {
